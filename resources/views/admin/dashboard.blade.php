        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sammy Sammy</div>
                    <div class="email">mngumi44@gmail.com</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">welcome to sammy's system</i>
            ...
            <div class="container">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{route('admin.beer.index')}}">

                            <span>beer</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.ourbeer.index')}}">

                            <span>ourbeer</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.bread.index')}}">

                            <span>bread</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.ourbread.index')}}">
