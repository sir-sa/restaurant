                    ...
                    <div class="row dis-table">
                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                <h2 class="section-content-title">{{$about->heading}}</h2>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item dinner,item breakfast,item desert,item breakfast special,item dinner special,item desert special">
                                    ...
                                    <a href="#">
                                        <img src="{{$price->image}}" class="img-responsive" alt="Food" >
            ...
            @foreach ($ourbeers as $ourbeer)
                ...
                <div class="container-fluid">
                    <div class="row dis-table">
                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                <h2 class="section-content-title">{{$ourbeer->heading}}</h2>
            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p>16th Birn street Get Plaza (4th floar) USA/kenya salit hotel</p>
                            <p>+44 12 213584 </p>
                            <p>+254 713643280 </p>
                            <p>sam@sam.com </p>
